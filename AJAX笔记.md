...
1. 打开备课代码运行图书管理案例效果-介绍要完成的增删改查业务效果和 Bootstrap 弹框使用
   ...
   ![image-20230404105414757](D:/HTML/Typora/ajax/images/image-20230404105414757.png)

   ![image-20230404105421707](D:/HTML/Typora/ajax/images/image-20230404105421707.png)
...
1. 什么是 Bootstrap 弹框？
   ...
   * 不离开当前页面，显示单独内容，供用户操作
     ...
     ![image-20230404105801739](D:/HTML/Typora/ajax/images/image-20230404105801739.png)

2. 需求：使用 Bootstrap 弹框，先做个简单效果，点击按钮，让弹框出现，点击 X 和 Close 让弹框隐藏

   ![image-20230404105858660](D:/HTML/Typora/ajax/images/image-20230404105858660.png)
...
1. 为什么需要 JS 方式控制呢？
   ...
   * 例如：
     ...
     * 点击保存按钮，在弹框隐藏之前，获取用户填入的名字并打印
     ...
     ![image-20230404110038828](D:/HTML/Typora/ajax/images/image-20230404110038828.png)
...
1. 需求：基于 axios 获取到图书列表数据，并用 JS 代码渲染数据，到准备好的模板标签中
   ...
   ![image-20230404110943200](D:/HTML/Typora/ajax/images/image-20230404110943200.png)
...
2. 步骤：
   ...
   2. 渲染数据
      ...
      ![image-20230404110953752](D:/HTML/Typora/ajax/images/image-20230404110953752.png)

      ![image-20230404111014560](D:/HTML/Typora/ajax/images/image-20230404111014560.png)
...
1. 需求：点击添加按钮，出现准备好的新增图书弹框，填写图书信息提交到服务器保存，并更新图书列表
   ...
   ![image-20230404111235862](D:/HTML/Typora/ajax/images/image-20230404111235862.png)

   ![image-20230404111251254](D:/HTML/Typora/ajax/images/image-20230404111251254.png)
...
2. 步骤：
   ...
   3. 刷新-图书列表）（重新调用下之前封装的获取并渲染列表的函数）
      ...
      ![image-20230404111343653](D:/HTML/Typora/ajax/images/image-20230404111343653.png)
...
1. 需求：点击图书删除元素，删除当前图书数据
   ...
   ![image-20230404111530311](D:/HTML/Typora/ajax/images/image-20230404111530311.png)

   ![image-20230404111546639](D:/HTML/Typora/ajax/images/image-20230404111546639.png)
...
2. 步骤：
   ...
   3. 重新获取并刷新图书列表
      ...
      ![image-20230404111612125](D:/HTML/Typora/ajax/images/image-20230404111612125.png)
...
2. 需求：完成编辑图书回显当前图书数据到编辑表单，在用户点击修改按钮，收集数据提交到服务器保存，并刷新列表
   ...
   ![image-20230404111722254](D:/HTML/Typora/ajax/images/image-20230404111722254.png)
...
3. 编辑数据的核心思路：
   ...
   2. 基于 axios 和接口文档，调用查询图书详情接口，获取正在编辑的图书数据，并回显到表单中（页面上的数据是在用户的浏览器中不够准备，所以只要是查看数据都要从服务器获取）
      ...
      ![image-20230404111739153](D:/HTML/Typora/ajax/images/image-20230404111739153.png)

   3. 收集并提交保存修改数据，并重新从服务器获取列表刷新页面

      ![image-20230404111756655](D:/HTML/Typora/ajax/images/image-20230404111756655.png)
...
1. 因为增删改查的业务在前端实际开发中非常常见，思路是可以通用的，所以总结下思路
   ...
   ![image-20230404111941722](D:/HTML/Typora/ajax/images/image-20230404111941722.png)
...
3. 新增数据（增）
   ...
   ![image-20230404112942935](D:/HTML/Typora/ajax/images/image-20230404112942935.png)
...
4. 删除图书（删）
   ...
   ![image-20230404113338815](D:/HTML/Typora/ajax/images/image-20230404113338815.png)
...
5. 编辑图书（改）
   ...
   ![image-20230404113702515](D:/HTML/Typora/ajax/images/image-20230404113702515.png)
...
1. 需求：先运行备课代码，查看要完成的效果，点击右上角选择本机中提供的素材图片，更换网站背景图
   ...
   ![image-20230404122349505](D:/HTML/Typora/ajax/images/image-20230404122349505.png)
...
1. 需求：先运行备课代码，查看要完成的效果
   ...
   ![image-20230404123206073](D:/HTML/Typora/ajax/images/image-20230404123206073.png)
...
1. 需求：把外号对应的个人信息和头像，渲染到页面表单和头像标签上。
   ...
   ![image-20230404123708765](D:/HTML/Typora/ajax/images/image-20230404123708765.png)
...
1. 需求：点击修改用户头像
   ...
   ![image-20230404124524401](D:/HTML/Typora/ajax/images/image-20230404124524401.png)
...
2. 实现步骤如下：
   ...
   3. 提交到服务器保存此用户对应头像文件，并把返回的头像图片 url 网址设置在页面上
      ...
      ![image-20230404124540629](D:/HTML/Typora/ajax/images/image-20230404124540629.png)
...
1. 需求：点击提交按钮，收集个人信息，提交到服务器保存（无需重新获取刷新，因为页面已经是最新的数据了）
   ...
   2. 提交到服务器保存-调用用户信息更新接口（注意请求方法是 PUT）代表数据更新的意思
      ...
      ![image-20230404125310049](D:/HTML/Typora/ajax/images/image-20230404125310049.png)
...
1. 需求：使用 bootstrap 提示框，提示个人信息设置后的结果
   ...
   ![image-20230404125517679](D:/HTML/Typora/ajax/images/image-20230404125517679.png)
...
3. 学习 XHR 也是了解 axios 内部与服务器交互过程的真正原理
   ...
   ![image-20230221182835545](D:/HTML/Typora/ajax/images/image-20230221182835545.png)
...
4. 语法如下：
   ...
   ![image-20230221183057392](D:/HTML/Typora/ajax/images/image-20230221183057392.png)
...
4. 需求：查询河北省下属的城市列表
   ...
   ![image-20230404133429378](D:/HTML/Typora/ajax/images/image-20230404133429378.png)
...
1. 需求：和我们之前做的类似，就是不用 axios 而是用 XHR 实现，输入省份和城市名字后，点击查询，传递多对查询参数并获取地区列表的需求
   ...
   ![image-20230221184135458](D:/HTML/Typora/ajax/images/image-20230221184135458.png)
...
2. 需求：通过 XHR 完成注册用户功能
   ...
   ![image-20230404135245271](D:/HTML/Typora/ajax/images/image-20230404135245271.png)
...
2. Promise 的好处是什么？
   ...
   * 了解 axios 函数内部运作的机制
     ...
     ![image-20230222113651404](D:/HTML/Typora/ajax/images/image-20230222113651404.png)
...
3. Promise 的状态改变有什么用：调用对应函数，改变 Promise 对象状态后，内部触发对应回调函数传参并执行
   ...
   ![image-20230222120815484](D:/HTML/Typora/ajax/images/image-20230222120815484.png)
...
2. 需求：使用 Promise 和 XHR 请求省份列表数据并展示到页面上
   ...
   ![image-20230404140252181](D:/HTML/Typora/ajax/images/image-20230404140252181.png)
...
1. 需求：基于 Promise 和 XHR 封装 myAxios 函数，获取省份列表展示到页面
   ...
   ![image-20230222130217597](D:/HTML/Typora/ajax/images/image-20230222130217597.png)
...
1. 需求：介绍本项目要完成的效果，和要实现的步骤和分的步骤和视频
   ...
   ![image-20230222133327806](D:/HTML/Typora/ajax/images/image-20230222133327806.png)
...
1. 介绍本视频要完成的效果：搜索匹配关键字相关城市名字，展示城市列表即可
   ...
   ![image-20230222133553010](D:/HTML/Typora/ajax/images/image-20230222133553010.png)
...
1. 介绍本视频要完成的效果：点击城市列表名字，切换当前页面天气数据
   ...
   ![image-20230222134653884](D:/HTML/Typora/ajax/images/image-20230222134653884.png)
...
1. 需求：展示默认第一个省，第一个城市，第一个地区在下拉菜单中
   ...
   ![image-20230222173109762](D:/HTML/Typora/ajax/images/image-20230222173109762.png)
...
3. 好处：通过链式调用，解决回调函数嵌套问题
   ...
   ![image-20230222173851738](D:/HTML/Typora/ajax/images/image-20230222173851738.png)
...
2. 做法：每个 Promise 对象中管理一个异步任务，用 then 返回 Promise 对象，串联起来
   ...
   ![image-20230222174946534](D:/HTML/Typora/ajax/images/image-20230222174946534.png)
...
4. 概念：执行代码和收集异步任务的模型，在调用栈空闲，反复调用任务队列里回调函数的执行机制，就叫事件循环
   ...
   */
   ...
   ![image-20230222182338992](D:/HTML/Typora/ajax/images/image-20230222182338992.png)
...
1. 需求：请根据掌握的事件循环的模型概念，分析代码执行过程
   ...
   */
   ...
   ![image-20230222183656761](D:/HTML/Typora/ajax/images/image-20230222183656761.png)
...
3. 宏任务和微任务具体划分：
   ...
   ![image-20230222184920343](D:/HTML/Typora/ajax/images/image-20230222184920343.png)
...
4. 事件循环模型
   ...
   */
   ...
   ![image-20230222184949605](D:/HTML/Typora/ajax/images/image-20230222184949605.png)
...
![image-20230222185205193](D:/HTML/Typora/ajax/images/image-20230222185205193.png)
...
1. 需求：请切换到对应配套代码，查看具体代码，并回答打印顺序（锻炼事件循环概念的理解，阅读代码执行顺序_）
   ...
   ![image-20230222185939276](D:/HTML/Typora/ajax/images/image-20230222185939276.png)
...
1. 概念：合并多个 Promise 对象，等待所有同时成功完成（或某一个失败），做后续逻辑
   ...
   ![image-20230222190117045](D:/HTML/Typora/ajax/images/image-20230222190117045.png)
...
3. 需求：同时请求“北京”，“上海”，“广州”，“深圳”的天气并在网页尽可能同时显示
   ...
   ![image-20230222190230351](D:/HTML/Typora/ajax/images/image-20230222190230351.png)
...
1. 需求：尽可能同时展示所有商品分类到页面上
   ...
   ![image-20230222191151264](D:/HTML/Typora/ajax/images/image-20230222191151264.png)
...
1. 需求：完成省市区切换效果
   ...
   ![image-20230222191239971](D:/HTML/Typora/ajax/images/image-20230222191239971.png)
